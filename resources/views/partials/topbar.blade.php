<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      <a class="navbar-brand mr-1" href="/dashboard">Acix Sales Pro</a>
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
        ...
        <li class="nav-item dropdown no-arrow ml-3">
          <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <img src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" class="rounded-full h-5 w-5 object-cover">
          </a>
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            <div class="dropdown-header">{{ Auth::user()->name }}</div> 
                <x-jet-dropdown-link href="{{ route('profile.show') }}">
                    <span class="dropdown-item"><i class="fa fa-user" > {{ __('Profile') }}</i></span>  
                </x-jet-dropdown-link>
            <div class="dropdown-divider"></div>
